...
try {
	...
	//compare incoming username, password with the Database
		//username, password
	ResultSet rs1 = stmt.executeQuery("SELECT mem_name_with_initials FROM t_member  WHERE mem_id ='"+memId+"' ");
	...
	if(rs1.next()){
		...
		//out.print(rs1.getString(1) );//write two
		out.print("ish");//write two
